class BackOffice::ResumesReplicasController < BackOfficeController
  ...
  def new
    ...
    if current_user.resumes_replicas.count == 0
  ...
  private
    ...
    def resume_params
      params.require(:resumes_replica).permit(:title, :about, :recruter_email, :recruter_full_name, :recruter_image_url, :job_description)
    end
end
